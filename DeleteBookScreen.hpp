...
private:
    ...
    sf::Text titleText, labelMaSach, errText, resultText; 
...
public:
    ...
    void setBookID(const std::string& id) { maSachField->setText(id); }
    void clear() { 
        maSachField->clear();
        errText.setString("");
