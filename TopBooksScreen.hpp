...
public:
    ...
    void loadBooks(sf::Font& font) {
        ...
        std::vector<sf::Color> colors = { 
            ...
            sf::Color(176, 224, 230), sf::Color(240, 230, 140), sf::Color(255, 192, 203), sf::Color(175, 238, 238) 
        };
        ...
        for (int i = 0; i < soLuong; ++i) {
            ...
            while(current != nullptr) {
                if (current->data->getMaSach() == id) {
                    ...
                    //  Dùng % colors.size() để đảm bảo không bao giờ vượt quá phạm vi
