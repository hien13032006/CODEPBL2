...
class SplashScreen {
private:
    sf::RectangleShape background, card; 
    sf::Text logoText, titleText, descText; 
    Button* startButton;
public:
